...
import { RegisterMuseumOwnerForm } from "../../_components/register-museum";
...
export default async function RegisterMuseumOwnerPage({ searchParams }: RoleProps){
    const resolvedSearchParams = await searchParams;
    const roles = resolvedSearchParams?.role || "";
    return (
        <>
            <AuthHeader />
            <div className="grid grid-cols-12 min-h-screen overflow-hidden">
                ...
                <div className="col-span-7 my-auto relative">
                    <RegisterMuseumOwnerForm role={roles} />
                </div>
