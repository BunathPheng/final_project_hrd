// 1. Google Login Component with proper role handling
...
const LoginGoogle: FC<LoginGoogleProps> = ({
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            // Use state parameter to pass role (this is the proper way)
            await signIn("google", {
                redirect: true,
